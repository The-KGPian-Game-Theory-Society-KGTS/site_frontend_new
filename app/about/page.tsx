        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-serif font-bold text-cream mb-4">
              What is <span className="text-red-500 filter drop-shadow-[0_0_8px_rgba(255,0,0,0.6)]">Game Theory</span>?
            </h1>
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <div className="bg-black/70 border border-red-600/30 rounded-lg p-8">
              <p className="text-cream/80 leading-relaxed mb-6 text-justify">
              ...
              <div className="gap-y-4">
                <div>
                  <h3 className="text-xl font-medium text-red-500 filter drop-shadow-[0_0_8px_rgba(255,0,0,0.6)] mb-3">Applications</h3>
                  <ul className="space-y-2 text-cream/80">
                    <li className="flex items-start">
                      <span className="text-red-500 mr-2">•</span>
                      <span className="text-justify">
                        <strong className="text-red-500 filter drop-shadow-[0_0_8px_rgba(255,0,0,0.6)]">Economics:</strong> Game theory helps analyze how individuals, firms, and markets make decisions when their outcomes depend on others. It's used to study competition, pricing strategies, auctions, bargaining, and market design to predict behaviors and improve efficiency.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-500 mr-2">•</span>
                      <span className="text-justify">
                        <strong className="text-red-500 filter drop-shadow-[0_0_8px_rgba(255,0,0,0.6)]">Computer Science:</strong> In computer science, game theory models interactions between algorithms or agents, such as in network security, distributed computing, and artificial intelligence. It helps design protocols where multiple users or systems act strategically, like in online auctions or resource allocation.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-500 mr-2">•</span>
                      <span className="text-justify">
                        <strong className="text-red-500 filter drop-shadow-[0_0_8px_rgba(255,0,0,0.6)]">Politics:</strong> Game theory models strategic interactions in voting, coalition building, diplomacy, and conflict. It helps predict how political actors behave in elections, negotiations, or international relations, offering insights into cooperation and competition dynamics.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-500 mr-2">•</span>
                      <span className="text-justify">
                        <strong className="text-red-500 filter drop-shadow-[0_0_8px_rgba(255,0,0,0.6)]">Policy Making:</strong> Policymakers use game theory to understand the strategic behavior of stakeholders, such as governments, corporations, and citizens. It aids in designing regulations, tax policies, and international agreements that account for incentives and potential responses.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-500 mr-2">•</span>
                      <span className="text-justify">
                        <strong className="text-red-500 filter drop-shadow-[0_0_8px_rgba(255,0,0,0.6)]">Medicine and Healthcare:</strong> Game theory is applied to model interactions between patients, healthcare providers, and insurers. It helps analyze vaccination decisions, epidemic control, treatment strategies, and resource allocation to improve health outcomes and policy design.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-500 mr-2">•</span>
                      <span className="text-justify">
                        <strong className="text-red-500 filter drop-shadow-[0_0_8px_rgba(255,0,0,0.6)]">Law:</strong> In law, game theory studies negotiation, litigation strategies, plea bargaining, and contract design. It helps predict how parties will behave during disputes or agreements, assisting in creating fair and efficient legal processes.
                      </span>
                    </li>
                  </ul>
                </div>
